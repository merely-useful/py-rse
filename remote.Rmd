...
## How are connections to remote computers implemented? {#s:remote-implement}
...
## How can I run commands on a remote computer? {#s:remote-ssh}
...
## How can I copy files to and from remote computers? {#s:remote-scp}
...
## How can I avoid typing my password over and over again? {#s:remote-keys}
