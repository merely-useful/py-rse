...
As with coding style (Chapter \@ref(s:style)),
...
-   The `./src/` directory contains a Makefile to re-build the `regulate` program (Chapter \@ref(s:automate)).
...
-   `LICENSE`:
    the project's license (discussed in Chapter \@ref(s:inclusive)).

-   `CONDUCT`:
    its code of conduct
    (also discussed in Chapter \@ref(s:inclusive)).
...
Like features (Chapter \@ref(s:branches)),
