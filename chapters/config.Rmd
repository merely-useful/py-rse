...
```{r configuration-jane-eyre-default, echo=FALSE, fig.cap="Word frequency distribution for Jane Eyre with default label sizes."}
...
```text
/Users/amira/anaconda3/lib/python3.9/site-packages/matplotlib/
...
live in a `python3.9/site-packages` directory,
...
```{r configuration-jane-eyre-big-labels, echo=FALSE, fig.cap="Word frequency distribution for Jane Eyre with larger labels."}
