...
```{r bash-basics-filesystem, echo=FALSE, fig.cap="Sample Filesystem", out.width="70%"}
...
```{r bash-basics-pipe, echo=FALSE, fig.cap="Piping commands", out.width="80%"}
knitr::include_graphics("figures/bash-basics/pipe.png")
```
...
knitr::include_graphics("figures/bash-basics/standard-io.png")
```
