...
we can change our prerequisites to for each result:
...
Let's modify the regeneration results code by 
creating names for the word-counting script and the command used to run it:
