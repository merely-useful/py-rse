...
and those programs will inevitably contain bugs.
We should therefore plan from the start to detect and handle errors.
This chapter will explore how to do this.

Before diving into the details,
it is helpful to have an overview of the error handling process.
...
they should be prevented by doing unit testing (Chapter \@ref(testing)),
