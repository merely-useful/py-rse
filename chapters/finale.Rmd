...
Every hour that a researcher *doesn't* waste re-doing a data analysis by hand
...
but we hope that knowing to to write, test, document, package, and share your work
