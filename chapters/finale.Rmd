...
Amira now has scripts, data sets and reports organized, 
in version control, 
and on GitHub. 
...
Because Amira has embraced GitHub and Make,
the colleague could easily suggest a fix through a Pull Request,
and Amira could easily regenerate all of the affected figures.
...
and issues countless commands to Git and Make. 
