...
FIXME: preamble talking about multiplicity of solutions

Commits included in solutions reference [Amira's `zipf` repository on GitHub][amira-repo],
which allows you to see the specific lines of a file modified to arrive at the answer. 
