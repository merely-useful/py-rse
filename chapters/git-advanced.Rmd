...
A copy of a repository is called a \gref{clone}{git_clone}(Figure \@ref(fig:git-cmdline-remote)c).\index{Git!clone a repository}\index{clone (in Git)}
