...
knitr::include_graphics("figures/py-rse/git-advanced/fork-button.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/after-fork.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/after-sami-pushes.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/open-pull-request.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/open-pull-request-detail.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/fill-in-pull-request.png")
```

```{r git-advanced-pull-request-new, echo=FALSE, fig.cap="New Pull Request"}
knitr::include_graphics("figures/py-rse/git-advanced/new-pull-request.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/viewing-new-pull-request.png")
```

```{r git-advanced-pull-request-list, echo=FALSE, fig.cap="Listing Pull Requests"}
knitr::include_graphics("figures/py-rse/git-advanced/pr-list.png")
```

```{r git-advanced-pull-request-details, echo=FALSE, fig.cap="Pull Request Details"}
knitr::include_graphics("figures/py-rse/git-advanced/pr-details.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/pr-changes.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/pr-comment-marker.png")
```

```{r git-advanced-pull-request-write-comment, echo=FALSE, fig.cap="Writing Comment"}
knitr::include_graphics("figures/py-rse/git-advanced/pr-writing-comment.png")
```

```{r git-advanced-pull-request-pr-with-comment, echo=FALSE, fig.cap="Pull Request With Comment"}
knitr::include_graphics("figures/py-rse/git-advanced/pr-with-comment.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/pr-with-fix.png")
```

```{r git-advanced-pull-request-successful-merge, echo=FALSE, fig.cap="Successful Merge"}
knitr::include_graphics("figures/py-rse/git-advanced/pr-successful-merge.png")
```
...
knitr::include_graphics("figures/py-rse/git-advanced/pr-conflict.png")
```
