...
For example,
here's a function for calculating someone's age from their birthday,
...
def calculate_age(birthday):
    ...
    no_bday_this_year_yet = (today.month, today.day) < (born.month, born.day)
...
We could format and organise the information in the docstring in any way we like,
...
(Section \@ref(packaging-document)) and is also the docstring format
recommended by [PEP 287][pep287]. 

https://www.python.org/dev/peps/pep-0287/.
The Sphinx website has a detailed guide 
