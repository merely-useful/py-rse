...
:   Human beings shouldn't have to indent code
    ...
    and hence more readable (Chapter \@ref(s:style)).
...
Debuggers and logging (Chapter \@ref(s:logging)) are complementary.
...
Section \@ref(s:unit-coverage) described how
...
-   a [linter](glossary.html#linter) that can warn you when your code doesn't meet naming and indentation conventions
    (discussed in Chapter \@ref(s:style));

-   some refactoring tools to help you reorganize your code
    (discussed in Chapter \@ref(s:refactor));
    and
