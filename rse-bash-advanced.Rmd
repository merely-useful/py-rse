...
Notice that it will *never* find the program `/users/amira/analyze`
unless we type in the full path to the program,
since the directory `/users/amira` isn't in `PATH`.
...
Thanks to this expansion, what we actually run is `echo /home/amira`,
...
For example,
here are two lines in `/home/amira/.bashrc`:
