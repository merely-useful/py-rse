...
## How can I tell if my code is a program or a module? {#rse-py-scripting-main}
...
## How can I handle command-line options? {#rse-py-scripting-options}
...
the online help has examples of this and much more.

## How can I configure common options for a program? {#rse-py-scripting-configure}
...
The modern Unix convention is to provide multiple levels of configuration:
...
the result is a [dictionary][dictionary].
...
## Where should configuration files go? {#rse-py-scripting-config-loc}
...
Alternatively,
some programs will set an environment variable (Section \@ref(rse-bash-advanced-vars))
...
> (Section \@ref(rse-git-advanced-tag)),
...
## How can I detect errors? {#rse-py-scripting-exceptions}
...
## What exceptions should I raise and catch? {#rse-py-scripting-where}
...
Internal errors should be forestalled by unit testing (Chapter \@ref(rse-correct)),
...
Section \@ref(rse-correct-random) described some ways to write unit tests
...
The error message shown in Figure \@ref(fig:rse-py-scripting-error-message) is not helpful:
...
## How should I report errors? {#rse-py-scripting-logging}
...
## How should I log my program's configuration? {#rse-py-scripting-log-config}
...
## Summary {#rse-py-scripting-summary}
...
## Exercises {#rse-py-scripting-exercises}

### Set the logging level {#rse-py-scripting-ex-set-level}

-   FIXME: use `getopt` and `--level NAME` to set logging level.

### Display logging configuration {#rse-py-scripting-ex-display-log-config}

-   FIXME: use `logging_tree.printout()` to display logging configuration.

### Log to standard error as well as a file {#rse-py-scripting-ex-log-stderr}

-   FIXME: modify `create_logger` to log to standard error as well as to a file.

## Key Points {#rse-py-scripting-keypoints}

```{r, child="keypoints/rse-py-scripting.md"}
```

## Exercises {#rse-py-scripting-ex}
