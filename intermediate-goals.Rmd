# Intermediate Outline {#intermediate-outline}
...
GVW: I have some of this in the novice outline - do you think it should all be here?
(We could stick to defensive programming in the novice material.)

Based on <http://swcarpentry.github.io/python-novice-inflammation/08-defensive/>,
...
GVW: I separated CI from testing because CI is also used to publish web sites when pure Jekyll isn't enough.
Happy to have it recombined, esp. if some of the testing material moves to the novice level.
