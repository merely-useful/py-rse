...
## What are realistic goals for testing? {#rse-unit-testing-goals}
...
## What does a systematic software testing framework look like? {#rse-unit-testing-systematic}
...
A [unit test](glossary.html#rse-unit-testing-test) is a function that runs some code and produces one of these three results.
...
## How can I manage tests systematically? {#rse-unit-testing-pytest}
...
## How can I tell if my software failed as it was supposed to? {#rse-unit-testing-exception}
...
============================= test session starts ==============================
platform darwin -- Python 3.6.5, pytest-3.5.1, py-1.5.3, pluggy-0.6.0
rootdir: /Users/hamilton/merely-useful/src/unit, inifile:
plugins: remotedata-0.2.1, openfiles-0.3.0, doctestplus-0.1.3, arraydiff-0.2
collected 1 item
...
## How can I test software that includes randomness? {#rse-unit-testing-random}
...
## How can I test software that does I/O? {#rse-unit-testing-io}
...
## How can I tell which parts of my software have (not) been tested? {#rse-unit-testing-coverage}
...
## Summary {#rse-unit-testing-summary}
...
## Exercises {#rse-unit-testing-exercises}
