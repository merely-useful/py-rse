...
As we'll later discuss in Section \@ref(rse-project-boilerplate),
...
6.  Describe each problem separately so that each one can be tackled on its own.
    ...
    discussed in Section \@ref(rse-git-advanced).
...
as described in Section \@ref(rse-project-boilerplate),
...
both in terms of collaborator guidelines (Section \@ref(rse-teams-issues)),
as well as tracking progress (Section \@ref(rse-teams-workflow)).
