# Working in Teams {#r-rse-teams}

```{r r-rse-teams-setup, include=FALSE}
source("_common.R")
```
...
covered in Section \@ref(r-rse-project) as well as tools from GitHub
as described in Section \@ref(r-rse-git-advanced).

## Why is it important to ensure everyone feels welcome to contribute? {#r-rse-teams-inclusive}
...
## Why should we establish a code of conduct for a project? {#r-rse-teams-coc}
...
As we'll later discuss in \@ref(r-rse-project-boilerplate),
...
## Why should we include a license? {#r-rse-teams-license}
...
Similar to the `CONDUCT` file described above and in Section \@ref(r-rse-project-boilerplate),
...
### How should we license our software? {#r-rse-teams-license-software}
...
### How should we license our data and reports? {#r-rse-teams-license-other}
...
## How can we keep track of the work we still have to do? {#r-rse-teams-planning}
...
## How can I write good bug reports? {#r-rse-teams-bugs}
...
6.  Describe each problem separately so that each one can be tackled on its own.
    ...
    discussed in Section \@ref(r-rse-git-advanced).
...
## How can we use labels to organize work? {#r-rse-teams-labels}
...
-   *Discussion* or *Proposal*: something the team needs to make a decision about
    ...
    as we'll discuss in Section \@ref(r-rse-teams-martha),
...
## How do we decide the priority of certain tasks? {#r-rse-teams-prioritize}
...
## How do we standardize a workflow for the project? {#r-rse-teams-workflow}
...
We can leverage our issue tracking system as described in Section \@ref(r-rse-teams-labels)
...
as described in \@ref(r-rse-project-boilerplate),
so newcomers (and existing participants!)
know what to expect.

## How can we make decisions as a group? {#r-rse-teams-martha}
...
and as we learned in Section \@ref(r-rse-teams-inclusive),
...
## How can we run meetings more efficiently? {#r-rse-teams-meetings}
...
## How can we keep people from talking too much or too little? {#r-rse-teams-fair}
...
## How should we run online meetings? {#r-rse-teams-online}
...
## How should we handle conflict within the team? {#r-rse-teams-conflict}
...
both in terms of collaborator guidelines (see \@ref(r-rse-teams-issues)),
as well as tracking progress (see \@ref(r-rse-teams-workflow)).
...
## How can we handle conflict to support an inclusive culture? {#r-rse-teams-conflict-inclusive}
...
## Summary {#r-rse-teams-summary}

FIXME: summarize r-rse-teams
highlight contributing guidelines, readme, CoC, etc

## Exercises {#r-rse-teams-exercises}

### ggplot2 contributing scavenger hunt {#r-rse-teams-ex-scavenger-hunt}

Take a look at the ggplot2 GitHub repository. Where is the information for license, contributing, etc?
https://github.com/tidyverse/ggplot2

### Responding to conflict about project priorities {#r-rse-teams-ex-priority-conflict}
