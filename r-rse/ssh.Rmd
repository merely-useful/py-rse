# Working Remotely {#r-rse-ssh}

```{r r-rse-ssh-setup, include=FALSE}
source("_common.R")
```
...
## How can I log in to a remote computer? {#r-rse-ssh-login}
...
## How can I copy files to and from a remote computer? {#r-rse-ssh-cp}
...
## How can I run commands on a remote computer? {#r-rse-ssh-cmd}
...
## How can I create keys so that I don't have to keep typing my password? {#r-rse-ssh-keys}
...
## What directories and files does SSH depend on? {#r-rse-ssh-filedir}
