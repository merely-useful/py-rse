...
-   `LICENSE` is the project's license (discussed in Chapter \@ref(rse-teams-license)).

-   `CONDUCT` is its code of conduct (also discussed in Chapter \@ref(rse-teams-coc)).
...
but two of these (`LICENSE` and `CONDUCT`) are usually chosen rather than written (Chapter \@ref(rse-teams-license))
...
-   **Give every part of the data a unique identifier.**
    ...
    To achieve this,
    the dataset itself should have a [DOI][doi] (Section \@ref(rse-publish-identifiers)),
    and within the dataset,
    every file should have a meaningful name (Section \@ref(rse-project-data-vs-code)).
    Going further,
    every record should have a unique [key][key] within the dataset (Section \@ref(rse-publish-data)):
