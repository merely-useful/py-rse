...
-   `LICENSE` is the project's license (discussed in Chapter \@ref(r-rse-teams-license)).

-   `CONDUCT` is its code of conduct (also discussed in Chapter \@ref(r-rse-teams-coc)).
...
but two of these (`LICENSE` and `CONDUCT`) are usually chosen rather than written (Chapter \@ref(r-rse-teams-license))
...
-   The `./src/` directory contains a Makefile to re-build the `regulate` program (Chapter \@ref(r-rse-automate)).
