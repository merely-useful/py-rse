# Publishing {#r-rse-publish}

```{r r-rse-publish-setup, include=FALSE}
source("_common.R")
```
...
That means publishing it under an open license (Section \@ref(r-rse-teams-software-license))
...
## How are reports and authors identified? {#r-rse-publish-identifiers}
...
## Where should I publish my reports? {#r-rse-publish-where}
...
## How should I publish data? {#r-rse-publish-data}
...
-   Give every dataset and every report a unique identifier (Section \@ref(r-rse-publish-identifiers)).
...
## What standards of data sharing should I aspire to? {#r-rse-publish-fair}
...
1.  (Meta)data is assigned a globally unique and persistent identifier (Section \@ref(r-rse-publish-identifiers)).
...
4.  (Meta)data is registered or indexed in a searchable resource,
    such as the data sharing platforms described in Section \@ref(r-rse-publish-data).
...
using the conventions described in Chapter \@ref(r-rse-project).
...
Be sure to give the dataset an identifier as discussed in Section \@ref(r-rse-publish-identifiers).
...
## How should I publish my software packages? {#r-rse-publish-software}
...
## How should I publish my other software? {#r-rse-publish-scripts}
...
As Section \@ref(r-rse-package-py-package) described,
...
For everything else,
you should write a script or create a rule in your project's Makefile (Chapter \@ref(r-rse-automate)),
...
## Summary {#r-rse-publish-summary}

FIXME: create concept map for publishing

## Exercises {#r-rse-publish-exercises}

### ORCID {#r-rse-publish-ex-get-orcid}
...
### A FAIR test {#r-rse-publish-ex-fair-test}
...
## Key Points {#r-rse-publish-keypoints}
