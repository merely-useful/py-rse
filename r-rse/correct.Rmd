...
```{r rse-correct-setup, include=FALSE}
...
```{r rse-correct-failed-test, echo=FALSE, fig.cap="Test Failure"}
...
```{r rse-correct-how-coverage-works, echo=FALSE, fig.cap="How Coverage Works"}
knitr::include_graphics("figures/FIXME.png")
```
...
## How can I test a program that uses random numbers? {#rse-correct-random}
