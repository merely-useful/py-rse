...
## How do I create and run unit tests in Python? {#r-rse-correct-create-python}
...
If the project uses a [build tool][build-tool] like Make (Chapter \@ref(r-rse-automate)),
...
## How do I create and run unit tests in R? {#r-rse-correct-create-r}
...
## How should I set up fixtures my unit tests? {#r-rse-correct-fixtures}
...
but each function only runs as far as the first failed check (Figure \@ref(fig:r-rse-correct-failed-test)).

```{r r-rse-correct-failed-test, echo=FALSE, fig.cap="Test Failure"}
...
## Why should I be cautious when using floating-point numbers? {#r-rse-correct-float}
