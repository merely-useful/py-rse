...
## How can I turn a set of Python source files into a module? {#package-modules}
...
## How can I control what is executed during import and what isn't? {#package-import}
...
## How can I install a Python package? {#package-install}
...
Section \@ref(package-virtualenv) shows how to avoid these problems.
...
## How can I create an installable Python package? {#package-package}
...
## How can I manage the source code of large packages? {#package-large}
...
## How can I distribute software packages that I have created? {#package-distribute}
...
## How can I manage the packages my projects need? {#package-virtualenv}
...
## How can I test package installation? {#package-test-install}
...
## Announcing Work {#package-announce}
