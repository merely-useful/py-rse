...
## Using Travis to test your Python project {#rse-ci-testing}
...
Getting Travis to run the unit tests in your package is as easy as modifying
the `.travis.yml` file in the script section to run `pytest`:
