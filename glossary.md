...
:   The value generated by running code in a test. If this matches the [expected_result](#expected_result), the test [passes](#pass_test); if the two are different, the test [fails](#fail_test). See also: [expected result (of test)](#expected_result)
