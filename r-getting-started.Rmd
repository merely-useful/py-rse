...
Objects can be much more complex, representing large datasets.
...
The first line is equivalent to clicking "Install," while the second line
performs the same task as checking the box in the Packages pane.
...
by prefacing a function with a question mark:
