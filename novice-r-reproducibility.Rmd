...
- How do I ensure my analyses are reproducible by others (and myself 9 months in the future)?
...
There are several cornerstones for rigorous and sound scientific evidence, two
of which are reproducibility and replicability. Replicability is when a study is
repeated by other independent research groups. Reproducibility is when scientific
results are verified by taking the same data and same analysis steps and 
Currently there is little effort in science for doing
reproducible research, in many ways due to a lack of training and awareness.
Being reproducible isn't also just about doing better science, it can also:
...
Like natural human languages, R has relaxed approach to how R code is written.
This has some nice advantages, but also some major disadvantages, notably that
writing style can be quite different across the world or even within a team. So,
it's important to stick to some guidelines, for instance, as laid out by the
...
TODO: Move solutions into end of chapter?
...
TODO: Expand on this section and more about usage.
...
`r AutoCite(bib, "Hoejsgaard2006a")`, and the reference is then inserted onto
