...
Section \@ref(s:unit-random) described some ways to write unit tests
...
Remember
if you need to write a parser, you've done something wrong (Chapter \@ref(s:rules)).
