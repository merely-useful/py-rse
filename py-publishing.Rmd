...
In the first cell create a markdown title that reads "Sharing work".
...
to indicate how web browsers should format the text.
...
so you can share a link instead of the file itself.
...
then rename `report.ipynb` to `index.ipynb`.
...
```
 ...
 <!--com: TODO talk about rmd or ipynb as the default? -->
Save the file as `index.ipynb`,
knit it,
commit,
and push your changes.
...
```
 ...
 <!--com: TODO this is not working for me -->
...
You can trigger this manually by going to GitHubPages settings
