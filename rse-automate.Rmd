...
## How can I update a file when its prerequisites change? {#rse-automate-first}
...
The "recipe" and rules around what to update or build are contained in a file
called `Makefile`. Let's create one in the root of our project with these lines:
...
## How can I update multiple files when their prerequisites change? {#rse-automate-extend}
...
## How can I get rid of temporary files that I don't need? {#rse-automate-phony}
...
## How can I make a target depend on several prerequisites? {#rse-automate-multi}
...
## How can I reduce the amount of typing I have to do? {#rse-automate-variables}
...
## How can I make one update depend on another? {#rse-automate-chain}
...
## How can I abbreviate my update rules? {#rse-automate-automatic}
...
## How can I write one general rule to update many files in the same way? {#rse-automate-pattern}
...
## How can I define sets of files automatically? {#rse-automate-functions}
...
## How can I document my workflow? {#rse-automate-doc}
