...
that depends on the results generated by `countwords.py` (FIXME: figure).
To create it,
...
Hint: it's not just the fact that the result no longer depends on the program used to create it.
