# Automating Analyses {#s:automate}
...
we will look at modifying the script in Chapter \@ref(s:configure)
...
As with most other rules about programming style (Chapter \@ref(s:style)),
...
is even harder.
Using an editor that does syntax highlighting helps (Chapter \@ref(s:tools)),
...
As we'll see in Chapter \@ref(s:integrate),
...
A better approach,
which we will explore in more depth in Chapter \@ref(s:docs),
