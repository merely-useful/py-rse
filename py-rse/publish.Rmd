...
That means publishing it under an open license (Section \@ref(py-rse-teams-license))
...
a large database of weather observations (and researchers have),
...
In Chapter \@ref(py-rse-package-py) we documented and packaged
...
## How should I publish my scripts? {#py-rse-publish-scripts}
...
If all of a program's parameters are in a configuration file (Chapter \@ref(py-rse-configuration)),
...
(Section \@ref(py-rse-errors-logging)).
