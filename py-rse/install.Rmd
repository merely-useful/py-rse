...
In order to complete the exercises in this book,
...
- *Linux*: Install it from the Bash shell using `sudo apt-get install make`.
...
See `data/README.md` for details of where the data came from.

[data-files]: {{ "../data/zipf.zip" | relative_url }}
