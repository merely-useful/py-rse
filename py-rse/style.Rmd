...
FIXME: create more exercises for coding style.

### Check the Zipf's scripts {#style-ex-check}

Use `pycodestyle` to check the style of the Python scripts in `zipf/bin`.  Do you find any style problems?
