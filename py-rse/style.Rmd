...
## Where should things appear in a source code file? {#py-rse-style-order}
...
## How can I improve code systematically? {#py-rse-style-refactor}
...
At the end of Section \@ref(py-rse-style-check),
...
Section \@ref(py-rse-git-advanced-pull-requests) explained how to create and merge pull requests.
...
:   Code review isn't just (or even primarily) about style:
    ...
    Are the calculations right?
    Are any rare cases going to be missed?
    Are errors being caught and handled Chapter \@ref(py-rse-errors-logging)?
...
## What features of Python can make code more readable? {#py-rse-style-features}
