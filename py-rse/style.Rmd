...
-   The commented-out `print` statements should either be removed
    or turned into proper logging statements (Section \@ref(py-rse-errors-logging)).
...
## How should I review someone else's code? {#py-rse-style-review}
...
## How should I collaborate with people when doing code reviews? {#py-rse-style-how}
