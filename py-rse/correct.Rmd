...
Do the exercise on fixing `numSign()` so the tests pass.

TODO: Add reference to exercise.
...
That's because `pytest` will print the tests that fail.
...
TODO: Exercise idea is to create the setup for a unit test for the `countwords.py` function.

TODO: Exercise to add unit testing command to the project Makefile.
...
TODO: Create exercise that tests countwords.py.
...
We'll cover this in more detail in the next section (TODO: add reference),
but essentially, testing floating-point values requires testing an approximation.
...
So, if the function we are testing uses floating point numbers,
...
TODO: Update this when I know more about how the plot scripts work.
...
TODO: Exercise, add a test dataset to the `test/` folder and testing suite.
...
TODO: Exercise. Run the coverage on the project. What does the project report say?

TODO: Add the coverage command to the project Makefile.
