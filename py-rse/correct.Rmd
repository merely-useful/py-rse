...
On the left,
besides the "My Repositories" link,
...
and our tests pass (Figure \@ref(fig:py-rse-correct-build-fail)).
...
Add the Travis CI display status to the README file
#[![Build Status](https://travis-ci.org/DamienIrving/zipf.svg?branch=master)](https://travis-ci.org/DamienIrving/zipf)
