...
## How do I create and run unit tests in R? {#py-rse-correct-create-r}
...
but it is all needed to create an R package (Chapter \@ref(py-rse-package-r)),
...
## How should I set up fixtures my unit tests? {#py-rse-correct-fixtures}
...
as we discuss in Section \@ref(py-rse-correct-float),
