...
## Chapter \@ref(py-rse-scripting)

### Exercise \@ref(py-rse-scripting-ex-command-line)

FIXME

### Exercise \@ref(py-rse-scripting-identify-words)
...
### Exercise \@ref(py-rse-scripting-ex-collate-count)
...
### Exercise \@ref(py-rse-scripting-ex-multiple-files)

FIXME

### Exercise \@ref(py-rse-scripting-ex-better-plotting)
...
FIXME: solutions for advanced Git exercises.
