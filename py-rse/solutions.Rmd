...
### Exercise \@ref(py-rse-bash-basics-ex-more-wildcards)
...
### Exercise \@ref(py-rse-bash-basics-ex-sort-n)
...
### Exercise \@ref(py-rse-bash-basics-ex-nested-loops)
...
### Exercise \@ref(py-rse-bash-basics-ex-list-unique)
...
### Exercise \@ref(py-rse-bash-advanced-ex-little-women)
...
### Exercise \@ref(py-rse-bash-advanced-ex-combining-options)

FIXME: write solution for combining options exercise

### Exercise \@ref(py-rse-bash-advanced-ex-other-wildcards)
...
### Exercise \@ref(py-rse-git-advanced-ex-additional-pr) {-}
