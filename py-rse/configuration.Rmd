...
We can see from opening this file that it lists all the default settings as comments.
...
If we wanted to make sure our plots are colorblind friendly,
...
and instead of placing it in the `/Users/amira/.matplotlib/stylelib/` directory
in order to create a new user-specific style sheet,
we can pass it directly to the `plotcounts.py` script
by defining a single new command line argument:
