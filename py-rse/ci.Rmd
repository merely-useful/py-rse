...
### Commit and push added code coverage{#py-rse-ci-exercises}

TODO: Fill out.

### Put the Travis README badge on your GitHub repo{#py-rse-ci-exercises}

Now that you've added the badge to the `README.md` file, do:

1. Commit the changes and push to GitHub.
2. Go to your GitHub project page and check that the badge renders.
3. Click the badge. Where does it take you?

### Write a test that will fail{#py-rse-ci-exercises}
