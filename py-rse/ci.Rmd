...
merge and test a project automatically whenever changes have been made.
This gives developers feedback about potential problems
while those new changes are still fresh in their minds.
...
### Get Travis to watch a repository
...
TODO: Remove so only the first two commands are added. Do the exercise on commit and pushing it.

TODO: Then add the install with requirements description. Do the exercise to make and fill in the requirements file.

TODO: Remove script section and move down to section for testing.
...
### Commit and push the Travis YAML file

TODO: Fill out.

### Fill in the requirements file

TODO: Fill out.

### Get Travis to run your tests
...
4. Check the log of the build. What does it say?

### Commit and push added code coverage

TODO: Fill out.

### Put the Travis README badge on your GitHub repo
