...
but two of these (`LICENSE` and `CONDUCT`) are usually chosen rather than written (Section \@ref(teams-license))
...
`README.md` was created as a part of Chapter \@ref(git-cmdline)
`CONDUCT.md` and `LICENSE.md` were both created in Chapter \@ref(teams).
...
1.  Most projects generate the documentation for their software directly from the source code
    (Section \@ref(package-py-document)).
...
or as a set of tasks in its issue tracking system (Section \@ref(teams-planning)).
