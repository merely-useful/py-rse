...
-   `LICENSE` is the project's license (discussed in Chapter \@ref(py-rse-teams-license)).

-   `CONDUCT` is its code of conduct (also discussed in Chapter \@ref(py-rse-teams-coc)).
