...
FIXME: In our case, a project describes the code, data, and documentation associated with our Zipf's Law project, and is contained within a single directory.
...
FIXME: boilerplate materials created in teams chapter
...
FIXME: add popout note about writing/reorganizing scripts that discusses adjustments to paths being referenced in those scripts
...
FIXME: relate to Zipfs law structure and organization
...
FIXME: does this connect to zipfs law?
...
FIXME: relate to existing functions?
...
FIXME: relate to data in project directory?
