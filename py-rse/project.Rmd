...
FIXME: back-ref to teams chapter in the paragraph below may turn into forward ref after we rearrange material.
...
FIXME: check contents of README to be consistent with changes in packaging chapter after the rearrangement.
...
-   The documentation for the `regulate` script appears in the root of `docs`,
...
FIXME: link this to discussion of Sphinx documentation in packaging chapter after rearrangement.
