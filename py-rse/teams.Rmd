...
## Why should we establish a code of conduct for a project? {#py-rse-teams-coc}
...
As we'll later discuss in \@ref(py-rse-project-boilerplate),
...
EXERCISE: create a document called CONDUCT and outline a few guidelines for interacting with your Zipf's law project
...
Similar to the `CONDUCT` file described above and in Section \@ref(py-rse-project-boilerplate),
...
EXERCISE: choose a license for the Zipf's law project
...
EXERCISE: example report on Zipf's law for analysis from specific book
...
EXERCISE: create an issue for a feature request (for something that will be completed in a subsequent chapter?)
...
```
EXERCISE: bug report (for something that will be resolved later?)
