...
if the project is being shared as a package (Chapter \@ref(package-py)).
...
2.  Try to come up with a [reproducible example][reprex] or "reprex"
    that includes only the steps or lines of code needed to make the problem happen.
    Again,
...
FIXME: how to respond to a bug report.
