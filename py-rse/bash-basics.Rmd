...
Please see Appendix \@ref(py-rse-install) for instructions
...
As we'll see in Chapter \@ref(py-rse-bash-advanced),
...
which tells us that we are in a directory called `amira` that is contained in a top-level directory called `Users`.
...
will put the command's output in a file
