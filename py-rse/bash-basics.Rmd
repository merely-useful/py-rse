...
If we want to see what's in the `zipfs-law` directory
...
so that we don't have to type `zipfs-law` over and over again.
...
`zipfs-law/data` contains the text files for several ebooks
...
by following the instructions in Appendix \@ref(py-rse-install).
...
### Other wildcards {#py-rse-bash-basics-ex-other-wildcards}
