...
Starting from a hypothetical directory located at `/Users/amanda/data`,
...
What would happen if you executed `rm -i thesis_backup/quotations.txt`
on a hypothetical file?
Why would we want this protection when using `rm`?

### Copy with multiple filenames {#py-rse-bash-basics-ex-copy-multi}

FIXME: specify where these files can be downloaded
