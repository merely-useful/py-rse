...
(Figure \@ref(fig:py-rse-bash-basics-repl)).
...
## Exploring Files and Directories {#py-rse-bash-basics-explore}
...
On Amira's computer
it looks like Figure \@ref(fig:py-rse-bash-basics-filesystem).
...
## Moving Around {#py-rse-bash-basics-navigate}
...
If we want to see what's in the `zipfs_law` directory
...
so that we don't have to type `zipfs_law` over and over again.
...
## Creating New Files and Directories {#py-rse-bash-basics-filedir}
...
## Moving Files and Directories {#py-rse-bash-basics-move}
...
## Copy Files and Directories {#py-rse-bash-basics-copy}
...
## Deleting Files and Directories {#py-rse-bash-basics-rm}
...
## Wildcards {#py-rse-bash-basics-wildcard}

`zipfs_law/data` contains the text files for several ebooks
...
> if two words are connected by a long dash---like "dash" and "like" in this sentence---
> then `wc` will count them as one word.
...
## Reading the Manual {#py-rse-bash-basics-help}
...
## Combining Commands {#py-rse-bash-basics-pipe}
...
## How Pipes Work {#py-rse-bash-basics-stdio}
...
and displays its output for us to see (Figure \@ref(fig:py-rse-bash-basics-stdio)a).
...
instead of the screen (Figure \@ref(fig:py-rse-bash-basics-stdio)c).
...
## Repeating Commands on Many Files {#py-rse-bash-basics-loops}
...
## Variable Names {#py-rse-bash-basics-meaningless}
...
## Redoing Things {#py-rse-bash-basics-history}
...
before executing it.
This means that (for example) `!572 > results.txt`
will the command's output into a file
...
## Creating New Filenames Automatically {#py-rse-bash-basics-autoname}
