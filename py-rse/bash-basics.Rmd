...
```shell
$ cp data/time_machine.txt backup/time_machine.bak
```

but can't do all the files at once:

```shell
$ cp data/*e.txt backup/*e.bak
```
...
`backup/*e.bak` doesn't match anything—those files don't yet exist—so
