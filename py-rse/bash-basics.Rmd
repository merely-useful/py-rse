...
knitr::include_graphics("figures/shared-rse/bash-basics/the_shell.png")
```
...
knitr::include_graphics("figures/shared-rse/bash-basics/sample_filesystem.png")
```
...
knitr::include_graphics("figures/shared-rse/bash-basics/nano_editor.png")
```
...
knitr::include_graphics("figures/shared-rse/bash-basics/standard_io.png")
```
...
```{r bash-basics-pipe, echo=FALSE, fig.cap="stdio and stdout with piping"}
knitr::include_graphics("figures/shared-rse/bash-basics/pipe.png")
```
