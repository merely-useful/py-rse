...
Let's start by going into `zipfs-law/bin` and creating a new file called `book_summary.sh`
...
```text
bin/             data/     makefiles/
backup/    book_summary.sh  Makefile  prior-work.txt
```
...
Let's edit `book_summary.sh` again and replace `data/moby_dick.csv`
