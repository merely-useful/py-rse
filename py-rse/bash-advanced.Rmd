...
> **Updates to comments are important, too!**
>
...
to put the most recent five commands in `summarize_all_books.sh`.
...
302 history 5 > summarize_all_books.sh
```

It only takes a few moments in an editor to remove the serial numbers
and delete extraneous line (`ls` and the last line)
