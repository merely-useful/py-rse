...
The current status of our Zipf's Law project includes the following files:
...
>
> We learned about tracking our project's version history using Git in
> Chapters \@ref(py-rse-git-cmdline) and \@ref(py-rse-git-advanced).
...
## Key Points {#py-rse-automate-keypoints}
