...
Amira is hosting on GitHub at `https://github.com/amira-khan/zipfs-law`.
...
```shell
jj:~/zipfs-law $ git log --oneline -n 4
```
...
```shell
sami:~/zipfs-law $ git remote add upstream https://github.com/amira-khan/zipfs-law.git
...
origin      https://github.com/sami/zipfs-law.git (fetch)
origin      https://github.com/sami/zipfs-law.git (push)
upstream    https://github.com/amira-khan/zipfs-law.git (fetch)
upstream    https://github.com/amira-khan/zipfs-law.git (push)
```
...
```shell
amira:~/zipfs-law $ git commit -m "Adding Sami as a contributor"
```
...
To https://github.com/amira-khan/zipfs-law.git
...
though,
she can easily pull those changes to her desktop:
...
From https://github.com/amira-khan/zipfs-law
