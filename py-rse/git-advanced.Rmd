...
Your `zipfs_law/` project directory should now include:
...
#### The math behind Zipf's Law {#py-rse-git-advanced-zipf-math}
...
Amira is hosting on GitHub at `https://github.com/amira-khan/zipfs_law`.
...
```shell
sami:~ $ git clone https://github.com/sami/zipfs_law.git
```

```text
Cloning into 'zipfs_law'...
...
```shell
jj:~/zipfs_law $ git log --oneline -n 4
```
...
```shell
jj:~/zipfs_law $ git remote -v
```

```text
origin  https://github.com/sami/zipfs_law.git (fetch)
origin  https://github.com/sami/zipfs_law.git (push)
```
...
```shell
sami:~/zipfs_law $ git remote add upstream https://github.com/amira-khan/zipfs_law.git
sami:~/zipfs_law $ git remote -v
```

```text
origin      https://github.com/sami/zipfs_law.git (fetch)
origin      https://github.com/sami/zipfs_law.git (push)
upstream    https://github.com/amira-khan/zipfs_law.git (fetch)
upstream    https://github.com/amira-khan/zipfs_law.git (push)
```
...
```shell
amira:~/zipfs_law $ nano README.md
amira:~/zipfs_law $ cat README.md
```
...
```shell
amira:~/zipfs_law $ git commit -m "Adding Sami as a contributor"
```
...
```shell
amira:~/zipfs_law $ git push origin master
```
...
To https://github.com/amira-khan/zipfs_law.git
...
```shell
sami:~/zipfs_law $ git pull upstream master
```
...
From https://github.com/amira-khan/zipfs_law
...
```shell
sami:~/zipfs_law $ git checkout -b adding-email
```
...
```shell
sami:~/zipfs_law $ nano README.md
sami:~/zipfs_law $ git commit -a -m "Adding my email address"
```
...
```shell
sami:~/zipfs_law $ git diff -r HEAD~1
```
...
```shell
sami:~/zipfs_law $ git push origin adding-email
```
...
remote:      https://github.com/sami/zipfs_law/pull/new/adding-email
remote:
To https://github.com/sami/zipfs_law.git
...
```shell
amira:~/zipfs_law $ git pull origin master
```
...
```shell
sami:~/zipfs_law $ git checkout master
```
