...
unless and until we explicitly combine whem with work done in another branch.
...
(Figure \@ref(fig:py-rse-git-cmdline-loglog-plot)).
...
## Creating a Branch {#py-rse-git-advanced-branch-how}
...
that we first saw in Section \@ref(py-rse-git-cmdline-restore):
...
## What Curve Should We Fit? {#py-rse-git-advanced-theory}
...
## Verifying Zipf's Law {#py-rse-git-advanced-zipf-verify}
...
Figure \@ref(fig:py-rse-git-advanced-dracula-fit) shows the plot.
...
## Merging {#py-rse-git-advanced-merge}
...
## Handling Conflicts {#py-rse-git-advanced-conflict}
...
## A Branch-Based Workflow {#py-rse-git-advanced-workflow}
...
## Using Other People's Work {#py-rse-git-advanced-fork}
...
the setup on GitHub now looks like Figure \@ref(fig:py-rse-git-advanced-after-fork).
...
```{r py-rse-git-advanced-after-fork, echo=FALSE, fig.cap="After Forking"}
knitr::include_graphics("figures/FIXME.png")
```
...
## Pull Requests {#py-rse-git-advanced-pull-requests}
...
(Figure \@ref(fig:py-rse-git-advanced-after-sami-pushes)).

FIXME: re-do this figure showing Sami instead of Jean Jennings

```{r py-rse-git-advanced-after-sami-pushes, echo=FALSE, fig.cap="After Sami Pushes"}
knitr::include_graphics("figures/FIXME.png")
```
...
(Figure \@ref(fig:py-rse-git-advanced-pull-request-start)).

```{r py-rse-git-advanced-pull-request-start, echo=FALSE, fig.cap="Starting Pull Request"}
knitr::include_graphics("figures/FIXME.png")
```

If they scroll down,
Sami can see a summary of the changes that will be in the pull request
(Figure \@ref(fig:py-rse-git-advanced-pull-request-summary)).

```{r py-rse-git-advanced-pull-request-summary, echo=FALSE, fig.cap="Summary of Pull Request"}
knitr::include_graphics("figures/FIXME.png")
```

They fill in the top two boxes
and click on "Create Pull Request"
(Figure \@ref(fig:py-rse-git-advanced-pull-request-fill-in)).
When they do,
GitHub displays a page showing the new pull request,
which has a unique serial number
(Figure \@ref(fig:py-rse-git-advanced-pull-request-new)).
...
```{r py-rse-git-advanced-pull-request-fill-in, echo=FALSE, fig.cap="Filling In Pull Request"}
knitr::include_graphics("figures/FIXME.png")
```

```{r py-rse-git-advanced-pull-request-new, echo=FALSE, fig.cap="New Pull Request"}
knitr::include_graphics("figures/FIXME.png")
```

Some time later,
Amira checks her repository and sees that there is a pull request
(Figure \@ref(fig:py-rse-git-advanced-pull-request-viewing)).
Clicking on the "Pull requests" tab brings up a list of PRs
(Figure \@ref(fig:py-rse-git-advanced-pull-request-list))
and clicking on the pull request link itself displays its details
(Figure \@ref(fig:py-rse-git-advanced-pull-request-details)).

```{r py-rse-git-advanced-pull-request-viewing, echo=FALSE, fig.cap="Viewing Pull Request"}
knitr::include_graphics("figures/FIXME.png")
```

```{r py-rse-git-advanced-pull-request-list, echo=FALSE, fig.cap="Listing Pull Requests"}
knitr::include_graphics("figures/FIXME.png")
```

```{r py-rse-git-advanced-pull-request-details, echo=FALSE, fig.cap="Pull Request Details"}
knitr::include_graphics("figures/FIXME.png")
```
...
(Figure \@ref(fig:py-rse-git-advanced-pull-request-changes)).

```{r py-rse-git-advanced-pull-request-changes, echo=FALSE, fig.cap="Files Changed"}
knitr::include_graphics("figures/FIXME.png")
```
...
(Figure \@ref(fig:py-rse-git-advanced-pull-request-comment-marker)).
...
(Figure \@ref(fig:py-rse-git-advanced-pull-request-write-comment)).
GitHub redisplays the page with her remarks inserted
(Figure \@ref(fig:py-rse-git-advanced-pull-request-pr-with-comment)).

```{r py-rse-git-advanced-pull-request-comment-marker, echo=FALSE, fig.cap="Comment Marker"}
knitr::include_graphics("figures/FIXME.png")
```

```{r py-rse-git-advanced-pull-request-write-comment, echo=FALSE, fig.cap="Writing Comment"}
knitr::include_graphics("figures/FIXME.png")
```

```{r py-rse-git-advanced-pull-request-pr-with-comment, echo=FALSE, fig.cap="Pull Request With Comment"}
knitr::include_graphics("figures/FIXME.png")
```
...
(Figure \@ref(fig:py-rse-git-advanced-pull-request-pr-with-fix)).
Satisfied,
...
(Figure \@ref(fig:py-rse-git-advanced-pull-request-successful-merge)).

```{r py-rse-git-advanced-pull-request-pr-with-fix, echo=FALSE, fig.cap="Pull Request With Fix"}
knitr::include_graphics("figures/FIXME.png")
```

```{r py-rse-git-advanced-pull-request-successful-merge, echo=FALSE, fig.cap="Successful Merge"}
knitr::include_graphics("figures/FIXME.png")
```
...
## Handling Conflicts in Pull Requests {#py-rse-git-advanced-pr-conflict}
...
(Figure \@ref(fig:py-rse-git-advanced-pr-conflict)).

```{r py-rse-git-advanced-pr-conflict, echo=FALSE, fig.cap="Conflict in a Pull Request"}
knitr::include_graphics("figures/FIXME.png")
```
...
https://github.com/github/gitignore is a collection of `.gitignore` files
