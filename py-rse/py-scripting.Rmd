...
the [online tutorial][argparse-tutorial] has examples of this and much more.
...
## How can I record the configuration that produced particular results? {#rse-py-scripting-save-config}
...
>
> Section \@ref(rse-py-scripting-save-config) explained why and how
