...
## Programs and Modules {#py-rse-py-scripting-main}
...
since it makes testing harder (Chapter \@ref(py-rse-correct)).
Instead,
...
## Handling Command-Line Options {#py-rse-py-scripting-options}
...
## Documentation {#py-rse-py-scripting-docstrings}
...
## Counting Words {#py-rse-py-scripting-wordcount}
...
```text
Counter({'the': 7474, 'and': 5803, 'I': 4846, 'to': 4662,
         'of': 3707, 'a': 2955, 'in': 2466, 'that': 2436,
         'he': 1996, 'was': 1870, 'it': 1808, 'is': 1498,
         'for': 1480, 'as': 1476, 'me': 1452, ...})
```
...
(Section \@ref(py-rse-bash-basics-stdio)).
...
## Pipelining {#py-rse-py-scripting-pipeline}
...
## Collating Results {#py-rse-py-scripting-collate}
...
We will talk more in Chapter \@ref(py-rse-project)
...
> so we normally tell Git to ignore it as discussed in Section \@ref(py-rse-git-cmdline-ignore).

## Plotting {#py-rse-py-scripting-plotting}
...
### Running Python statements from the command line {#py-rse-scripting-ex-command-line}
...
### Collating while counting {#py-rse-scripting-ex-collate-count}
...
### Optional output file {#py-rse-scripting-ex-collate-count}

We decided in Section \@ref(py-rse-py-scripting-pipeline)
...
### Multiple files and standard input {#py-rse-scripting-ex-multiple-files}
...
### A better plotting program {#py-rse-scripting-ex-better-plotting}
