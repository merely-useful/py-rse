...
### Running Python statements from the command line {#py-rse-py-scripting-ex-command-line}
...
### Better word identification {#py-rse-py-scripting-identify-words}
...
### Collating while counting {#py-rse-py-scripting-ex-collate-count}
...
### Optional output file {#py-rse-py-scripting-ex-optional-outfile}
...
### Multiple files and standard input {#py-rse-py-scripting-ex-multiple-files}
...
### A better plotting program {#py-rse-py-scripting-ex-better-plotting}
