...
as well as ways to manage the progress of the project and team as it develops.
...
FIXME: include assumption of GitHub as a mechanism used in this section,
cross-reference material in rse-git-advanced.Rmd

## Why is it important to ensure everyone feels welcome to contribute? {#rse-teams-inclusive}

FIXME: difference between open and welcoming
...
FIXME: why we should strive for a diverse group
...
FIXME: CONDUCT file, reference \@ref(rse-project-boilerplate)
...
## How can I write good bug reports? {#novice-collaboration-bugs}
