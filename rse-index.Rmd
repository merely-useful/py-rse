...
author: "Dhavide Aruliah, Madeleine Bonsma-Fisher, Kate Hertweck, Damien Irving, Luke Johnston, Christina Koch, Sara Mahallati, Brandeis Marshall, Joel Ostblom, Elizabeth Wickes, Charlotte Wickham, and Greg Wilson"
date: "`r Sys.Date()`"
...
and the aim of this book is to get you ready for this roles—to help you go from writing code for your own use
...
:   completed a master's in library science five years ago
    and has worked since then for a small aid organization.
...
:   became a competent programmer during a bachelor's degree in applied math
    and then was hired by the university's research computing center.
...
-   Create reproducible reports using [R Markdown][r-markdown] or [Jupytext][jupytext].
...
This isn't just [impostor syndrome][impostor-syndrone]:
...
-   Document software so that other people can use it, maintain it, and extend it.
-   Create packages that other people can install in standard ways.
...
and the authors of [@Hadd2010;@Nobl2009;@Wils2014;@Tasc2017;@Wils2017;@Brow2018;@Deve2018;@Shol2019;@Wils2019].
