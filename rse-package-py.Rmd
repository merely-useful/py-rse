...
```{r rse-package-py-setup, include=FALSE}
source("_common.R")
```
...
FIXME: introduce the name 'namespace' earlier if it doesn't come up in earlier sections
...
```{r rse-package-py-virtualenv, echo=FALSE, fig.cap="Virtual Environments"}
...
<!-- used="rse-package-py/08/requirements.txt" -->
<!-- used="rse-package-py/08/test_zipfpy.py" -->
<!-- used="rse-package-py/08/zipfpy/__init__.py" -->
<!-- used="rse-package-py/08/zipfpy/check.py" -->
<!-- used="rse-package-py/08/zipfpy/generate.py" -->
