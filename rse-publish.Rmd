...
along with any software and code used to download and process the data.
...
The same is not true for analysis code.
...
The next item you’ll need to publish is a copy of the code
written to execute those software packages.
Depending on the size or complexity of the code you have written,
...
they also need to know how that code was actually executed.
...
**Publishing your analysis code**

Think about a project that you're currently working on.

How would you go about publishing the analysis code associated with that project?
(i.e. the software description, code and data processing steps)
