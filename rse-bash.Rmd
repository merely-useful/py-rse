...
README.md       cooked/         raw/            thesis.pdf
```
...
```text
NOTES           analysis/       cooked/         raw/            thesis.pdf
...
```text
NOTES           analysis/       cooked/         prior-work.txt  thesis.md       tofu.config
...
The `cooked` directory in our climate data project contains
...
```shell
$ wc cooked/andamooka_prec.csv
```

```text
20003   20004  401858 cooked/andamooka_prec.csv
```
...
so `cooked/*.csv` matches all of the files in the `cooked` directory:
...
```text
cooked/andamooka_prec.csv       cooked/badingarra_prec.csv      cooked/bellambi_prec.csv        cooked/tuggeranong_prec.csv
cooked/andamooka_temp.csv       cooked/badingarra_temp.csv      cooked/bellambi_temp.csv        cooked/tuggeranong_temp.csv
```

while `cooked/b*.csv` only matches the four whose names begin with a 'b':
...
```text
cooked/badingarra_prec.csv      cooked/badingarra_temp.csv      cooked/bellambi_prec.csv        cooked/bellambi_temp.csv
```
...
```text
   20003   20004  401858 cooked/andamooka_prec.csv
   21099   21100  406584 cooked/badingarra_prec.csv
    8315    8316  169740 cooked/bellambi_prec.csv
    8681    8682  175998 cooked/tuggeranong_prec.csv
...
```text
    8681    8682  175998 cooked/tuggeranong_prec.csv
    8680    8681  196212 cooked/tuggeranong_temp.csv
...
```text
wc: cooked/*.txt: open: No such file or directory
```
...
```shell
$ wc -l cooked/*_prec.csv
```

```text
   20003 cooked/andamooka_prec.csv
   21099 cooked/badingarra_prec.csv
    8315 cooked/bellambi_prec.csv
    8681 cooked/tuggeranong_prec.csv
   58098 total
```
...
> <kbd>Spacebar</kbd> or <kbd>F</kbd>,
> or back one by pressing <kbd>Control</kbd>+<kbd>Spacebar</kbd> or <kbd>B</kbd>.
> Press <kbd>/</kbd> to search, <kbd>N</kbd> and <kbd>Shift</kbd>+<kbd>N</kbd> to navigate between search hits,
> and <kbd>Q</kbd> to quit `less`.
