...
number of commands gets you a long way, and we'll cover those essential few in this lesson.
...
Underneath `/Users`,
we find one directory for each user with an account on beatrice's machine,
...
in `/Users/beatrice/Desktop/data-shell/data`.
