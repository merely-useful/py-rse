...
## Navigating Files and Directories {#rse-bash-navigation}
...
which is the path to Beatrice's **home directory**:
...
illustrating the file system on Beatrice's computer. After this
illustration, you'll be learning commands to explore your own file system,
which will be constructed in a similar way, but not be exactly identical.

On Beatrice's computer, the file system looks like this:
...
and Beatrice's in `/Users/beatrice`.  Because Beatrice is the logged in user in
our examples, `pwd` returns `/Users/beatrice` as our home directory.
Typically, when you open a new command prompt you will be in
your home directory to start.

Now let's learn the command that will let us see the contents of our
own file system.  We can see what's in our home directory by running `ls`,
...
> directory. For example, to move from `/Users/beatrice/data` to
> `/Users/beatrice/molecules` you can type `cd ../molecules`.

So these are the basic commands for navigating the file system on your computer:
...
which is great if you've gotten lost in your own file system.
...
the file system (including from inside `data`).  To find the absolute path
...
Using the file system diagram below, if `pwd` displays `/Users/thing`,
...
Using the file system diagram below,
