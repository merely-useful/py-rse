...
The computer might put the data in a temporary file,
leave it in memory,
or something else entirely:
all that matters to use is that everything the first command prints
...
## How do pipes work? {#rse-bash-stdio}
