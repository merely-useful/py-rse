...
### Creating functions {py-creating-functions}
...
#### Function composition {py-function-composition}
...
#### Defining default values {py-defining-default-values}
...
#### Function documentation {py-function-documentation}
...
### Applying what we have learnt {py-applying-what-we-have-learnt}
...
{py-how-to-make-programs-indicate-that-something-has-gone-wrong?}
...
### Ducktyping - relying on Python to detect unexpected behavior {py-ducktyping
--relying-on-Python-to-detect-unexpected-behavior}
...
### Assertions - explicitly checking for unexpected behavior {py-assertions--
explicitly-checking-for-unexpected-behavior}
...
### Installing Python {py-installing-Python}
...
### What is a package {py-what-is-a-package}
...
### Importing packages {py-importing-packages}
...
### Installing packages {py-installing-packages}
...
## How to get help online {py-how-to-get-help-online}
...
1. Write a function that returns the mean of exactly two numbers.
2. Write a function that returns the mean of any amount of numbers.
3. Write function that takes a string as its input and returns the
   first and last character of the string.
4. Write a function that returns any character from the string. Which character
   is returned should be determined by an integer specified via a named
   parameter that has the default value of `0`.
5. Expand on the previous function by include a assert statement that checks if
   the given integer is within the range of the string. In this case, does this
   approach offer any advantages over ducktyping?
