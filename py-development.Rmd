...
```{r child="questions/py-development.md"}
```

## Objectives {#py-dev-objectives}

```{r child="objectives/py-development.md"}
```
...
Python keyword and built-in names (a list of these is available
...
```{r spyder-docstring, echo=FALSE, fig.cap="Rich rendering of the docstring in Spyder"}
insert_graphic('figures/py-development/docstring-spyder.png')
```
...
### Applying what we have learnt {#py-dev-applying-what-we-have-learnt}
...
{#py-dev-how-to-make-programs-indicate-that-something-has-gone-wrong?}
...
### Ducktyping - relying on Python to detect unexpected behavior {#py-dev-ducktyping
...
### Assertions - explicitly checking for unexpected behavior {#py-dev-assertions--
...
```{r child="keypoints/py-development.md"}
```
