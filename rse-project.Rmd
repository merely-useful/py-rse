...
```
## Elizabeth's dump of materials

I'm reprising an email I sent to Kate with these.  

Here’s a small collection of my data management materials.  For context, I worked in research data management librarianship and still instruct and publish in that area.
 
Here’s a workshop I wrote, with slides and a handout.  The handout is meant to be run through in about 30 minutes with some guidance.  There is a little exercise to help them think about the importance of documentation and metadata. This is using open materials, and something that could be included in the book.  It can run in about 10 minutes and creates some pretty good discussion. https://www.ideals.illinois.edu/handle/2142/91611
 
The workshop then gives a series of prompts to set the tone for their data documentation needs. Step 2 asks them to think about and identify an audience and timeline.  This gives perspective on how to prioritize the depth and sustainability of the documentation.
 
Step 3 takes them through identifying the pieces they have and starting to sketch out the products of their research.
 
Step 4 is my response to the overly detailed readme guides. It has an outline of the many options that can go into a readme file, and they can go through and mark the ones that are relevant.  They are also prompted to add initials or other symbols to indicate assignment of who should be creating that documentation and indicate other factors like time scale or priority.  This should give them direction for what to look into when they arrive in the super dense but useful readme guides out there.
 
I’m also attaching the brief slides for my class where I step them through creating a low key file structure that includes backups of their original data, a cloud backup, and tracking their data files under version control.  This has been a good solution for this class over two semesters, where students are able to keep up with it and are able to start using github for everything.  Here’s also my github workshop(https://github.com/elliewix/github-training-brain-dumps/blob/master/github_directions.md) that runs cleanly in about an hour or less, and has been good enough to get all my students started with using it.  I’ve run this workshop about 10 times now in classes and other short forms, and people leave happy and actively using github for their project.  I just used this for a 3 hour class last week, where we started with this, and then went through the first chunk of the swc git lesson.  Which was just about right.  
 
For a bonus, I also have this data workflows workshop which I’ve run like 20+ times at this point with really positive feedback.  I have all my students complete it independently as part of planning for their final projects and many reported it really helped them plan things and organize their data ahead of the game.  https://www.youtube.com/watch?v=hseix4TH0eU
 
Here’s also a poster where I mocked up data management training under the lens of behavioral change theory:  https://www.ideals.illinois.edu/handle/2142/95074
