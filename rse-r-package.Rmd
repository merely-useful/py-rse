...
-   The `tests` directory holds the package's unit tests.
    ...
    We'll have a closer look at these in Chapter \@ref(rse-unit-testing).
...
```{r rse-r-package-concept, echo=FALSE, fig.cap="R Packaging Concept Map"}
if (knitr::is_latex_output()) {
  knitr::include_graphics("figures/rse-r-package/rse-r-package.pdf")
} else {
  knitr::include_graphics("figures/rse-r-package/rse-r-package.svg")
}
```
