...
````markdown
`r ''````{r co2-time-plot, fig.cap="Add your figure title here.", fig.height=8, fig.width=8}
ggplot(co2_data, aes(x = year, y = co2_standard)) +
    geom_point()
`r ''````
````

```{r co2-time-plot-1, fig.cap="Add your figure title here.", fig.height=8, fig.width=8}
ggplot(co2_data, aes(x = year, y = co2_standard)) +
    geom_point()
```
...
````markdown
`r ''````{r co2-time-plot-after-2000, fig.cap="Add your figure title here.", fig.height=8, fig.width=8}
