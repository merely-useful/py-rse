...
Status: First draft complete (#105)  
Source materials:
...
Lead author: Damien Irving
Status: First draft ready for review (#164)
Source materials:
...
Lead author: Unassigned  
Status: unassigned (#48)  
Source materials: [Software Carpentry](http://swcarpentry.github.io/make-novice/), 
...
Status: First draft in progress (#106)  
Source materials: [Katy Huff](http://katyhuff.github.io/python-testing/), [unit.Rmd](https://merely-useful.github.io/still-magic/en/unit.html), [verify.Rmd](https://merely-useful.github.io/still-magic/en/verify.html)
...
Status: First draft in progress (#99)
...
[backlog.Rmd](https://merely-useful.github.io/still-magic/en/backlog.html), [teamwork.Rmd](https://merely-useful.github.io/still-magic/en/teamwork.html)
...
Status: First draft of R packaging complete (#87), first draft Python packaging ready for review (#117)  
...
Lead author: Damien Irving  
Status: First draft is complete (#142)  
...
- [Documentation](https://merely-useful.github.io/still-magic/en/docs.html), #158
...
- [Working remotely](https://merely-useful.github.io/still-magic/en/remote.html), #157
...
- [Pacing](https://merely-useful.github.io/still-magic/en/pacing.html)
