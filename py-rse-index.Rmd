...
how to use version control to keep track of what you have done,
and how to share your software and results with other people.
...
and the aim of this book is to get you ready for this role—to help you go from writing code for yourself
...
## What's the big picture? {#py-rse-intro-big-picture}
...
## Who are these lessons for? {#py-rse-intro-personas}
...
-   Write functions to analyze tabular data using [Python][python].
    (A companion volume covers this material using [R][r].)
-   Keep track of their work using [Git][git] and [GitHub][github].
-   Create reproducible reports using [JupyterLab Notebooks][jupyter].
-   Publish reports with appropriate metadata such as a [DOI][doi] and [ORCID][orcid].
...
Please see Appendix \@ref(py-rse-install) for pointers on how to set all of this up.

## Syllabus {#py-rse-intro-syllabus}
...
Appendix \@ref(py-rse-install) explains
...
## Acknowledgments {#py-rse-intro-ack}
