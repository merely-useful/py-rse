...
-   writing loops, conditionals, and functions; and
-   saving their work in a Git repository using a graphical interface.
...
Please see Appendix \@ref(py-rse-install) for instructions on how to set all of this up.
