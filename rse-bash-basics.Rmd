...
```{r rse-bash-setup, include=FALSE}
source("_common.R")
```
...
```{r rse-bash-basics-repl, echo=FALSE, fig.cap="The Shell"}
...
```{r rse-bash-basics-filesystem, echo=FALSE, fig.cap="Sample Filesystem"}
knitr::include_graphics("figures/FIXME.png")
```
...
```{r rse-bash-basics-nano, echo=FALSE, fig.cap="The Nano Editor"}
knitr::include_graphics("figures/FIXME.png")
```
...
```{r rse-bash-basics-stdio, echo=FALSE, fig.cap="Standard I/O"}
knitr::include_graphics("figures/FIXME.png")
```
...
```{r rse-bash-basics-misconnect, echo=FALSE, fig.cap="Misconnection"}
knitr::include_graphics("figures/FIXME.png")
```
...
```{r rse-bash-basics-ex-rel-path, echo=FALSE, fig.cap="Exercise Filesystem"}
knitr::include_graphics("figures/FIXME.png")
```
...
```{r rse-bash-basics-ex-reading-ls, echo=FALSE, fig.cap="Filesystem for Exercise"}
knitr::include_graphics("figures/FIXME.png")
```
