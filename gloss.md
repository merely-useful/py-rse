...
:   Is a reference to a folder or file that begins at the [working directory][working-directory],
...
:   Is a way of showing a code example that demonstrates the usage of the code
...
:   Is a central pillar of rigorous research that involves describing and documenting
